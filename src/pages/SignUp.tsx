    ...
    <div className="min-h-screen flex bg-white relative">
      ...
      <div className="flex flex-col justify-center items-center w-full max-w-lg px-8 py-12 mx-auto ml-24">
        <div className="w-full max-w-sm">
          <h2 className="text-2xl font-light mb-1 text-black">Get started</h2>
          <p className="text-slate-600 mb-6 text-sm">Create a new account</p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-2">
            ...
            <input
              ...
              required
            />
            <label className="text-slate-700 text-sm mb-1 mt-2">Password</label>
          ...
          <div className="text-center mt-4 text-sm">
            Have an account?{' '}
            <button type="button" className="text-blue-700 font-semibold hover:underline" onClick={() => navigate('/signin')}>
              Sign In Now
            </button>
          </div>
        </div>
